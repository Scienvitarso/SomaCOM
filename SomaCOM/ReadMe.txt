========================================================================
    ACTIVE TEMPLATE LIBRARY : SomaCOM Project Overview
========================================================================

AppWizard has created this SomaCOM project for you to use as the starting point for
...
SomaCOM.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (SomaCOM.h)
        GUID definitions                                (SomaCOM_i.c)
        A type library                                  (SomaCOM.tlb)
        Marshaling code                                 (SomaCOM_p.c and dlldata.c)

SomaCOM.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in SomaCOM.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named SomaCOM.pch and a precompiled types file named StdAfx.obj.
...
SomaCOMps.vcxproj
	...
	dlldata.c, SomaCOM_i.c and SomaCOM_p.c which are required
	to build the proxy/stub DLL.

SomaCOMps.vcxproj.filters
